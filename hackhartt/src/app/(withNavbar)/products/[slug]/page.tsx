            ...
            <div className="flex mx-auto h-screen w-full bg-white ">
                ...
                <div className="flex-1 w-full mx-12 mt-24">
                    ...
                    <div className="mt-6">
                        ...
                        <p className="mt-2  text-orange-600 ">£{(product?.data.price)}</p>
                    </div>
                    ...
                    <Link href="/products">
                        <button className="bg-white btn btn-ghost hover:bg-blue-600 text-black font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline w-full mt-12">
